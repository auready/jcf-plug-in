...
public class DatabaseService {
	...
	public String[] getTableNames() {
		List<String> list = this.jdbcTemplate.queryForList(this.createQuery("ORACLE_TABLE_NAME", null), String.class);
	...
	public List<TableColumns> getColumnList(String tableName) {
		...
		List<Map> rows = this.jdbcTemplate.queryForList(this.createQuery("ORACLE_COLUMN_NAME", map));
